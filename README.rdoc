...
Error message when creating a new item:

Started POST "/items" for ::1 at 2016-05-25 21:28:07 -0400
Processing by ItemsController#create as JS
  Parameters: {"utf8"=>"✓", "item"=>{"title"=>"Test Number One", "composer_fname"=>"Pete", "composer_lname"=>"Taylor", "arranger"=>"", "publisher"=>"Exxon Publishers INC.\r\n", "ensemble"=>"band", "level"=>"Elementary", "location"=>"Argus Music Conservatory", "comments"=>""}, "commit"=>"Create Item"}
...
ActiveRecord::RecordNotFound (Couldn't find User with 'id'=):
  app/controllers/items_controller.rb:54:in `create'


  Rendered /Users/timdeyoung/.rvm/gems/ruby-2.3.0/gems/actionpack-4.2.5.1/lib/action_dispatch/middleware/templates/rescues/_source.erb (3.7ms)
  Rendered /Users/timdeyoung/.rvm/gems/ruby-2.3.0/gems/actionpack-4.2.5.1/lib/action_dispatch/middleware/templates/rescues/_trace.text.erb (1.5ms)
  Rendered /Users/timdeyoung/.rvm/gems/ruby-2.3.0/gems/actionpack-4.2.5.1/lib/action_dispatch/middleware/templates/rescues/_request_and_response.text.erb (1.3ms)
  Rendered /Users/timdeyoung/.rvm/gems/ruby-2.3.0/gems/actionpack-4.2.5.1/lib/action_dispatch/middleware/templates/rescues/diagnostics.text.erb (79.1ms)