...
class DistrictsControllerTest < ActionController::TestCase
  ...
  test "should create district" do
    assert_difference('District.count') do
      post :create, district: { contact_email: @district.contact_email, contact_person: @district.contact_person, contact_phone: @district.contact_phone, title: @district.title }
    end
  ...
  test "should update district" do
    patch :update, id: @district, district: { contact_email: @district.contact_email, contact_person: @district.contact_person, contact_phone: @district.contact_phone, title: @district.title }
    assert_redirected_to district_path(assigns(:district))
  end
